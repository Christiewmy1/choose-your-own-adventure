...
ok before we do implementation, let ne first ask you exploratory questions. Let us plan how to develop code before we start implementation. So lets do it and develop a general approach. 
